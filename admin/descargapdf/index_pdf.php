            ...
            <div class="row">
              ...
              <!--  <img class="img-responsive" src="img/profile.png" alt=""> -->
                    <div class="intro-text">
                        <a href="pdf_descarga.php?toprint=usuarios">
                            <span class="name" id="blanco">Descargar PDF usuarios</span>
                        </a>
                        <hr class="star-light">
                        <span class="skills">
                        </span>
                    ...
                    <div class="intro-text">
                        <a href="pdf_descarga.php?toprint=canciones">
                            <span class="name" id="blanco">Descargar PDF canciones</span>
                        </a>
                        <hr class="star-light">
                        <span class="skills">                          
                    ...
                    <div class="intro-text">
                        <a href="pdf_descarga.php?toprint=videos">
                            <span class="name" id="blanco">Descargar PDF videos</span>
                        </a>
                        <hr class="star-light">
                        <span class="skills">                           
